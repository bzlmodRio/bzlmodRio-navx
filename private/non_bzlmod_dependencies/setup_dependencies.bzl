...
load("@navx//:maven_java_deps.bzl", "get_navx_java_dependencies")
...
def get_java_dependenicies():
    ...
    maven_artifacts, maven_repositories = _combine_maven_info(maven_artifacts, maven_repositories, get_navx_java_dependencies)
    maven_artifacts, maven_repositories = _combine_maven_info(maven_artifacts, maven_repositories, get_allwpilib_java_dependencies)
    maven_artifacts, maven_repositories = _combine_maven_info(maven_artifacts, maven_repositories, get_wpi_opencv_java_dependencies)
