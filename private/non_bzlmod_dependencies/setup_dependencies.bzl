...
load("@navx//:maven_java_deps.bzl", "setup_legacy_navx_java_dependencies")
load("@allwpilib//:maven_cpp_deps.bzl", "setup_legacy_allwpilib_cpp_dependencies")
load("@allwpilib//:maven_java_deps.bzl", "get_allwpilib_java_dependencies", "setup_legacy_allwpilib_java_dependencies")
...
def _setup_java_dependencies():
    setup_legacy_navx_java_dependencies()
    setup_legacy_allwpilib_java_dependencies()
    setup_legacy_wpi_opencv_java_dependencies()
